...
public class UserController {
	...
	@GetMapping("/user/buy-now/{id}")
	public String buyNow(@PathVariable Long id, HttpSession session, Principal principal) {
		return userService.buyNow(id, session, principal);
	}
}
